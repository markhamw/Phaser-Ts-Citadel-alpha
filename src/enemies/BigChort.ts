...
export default class BigChort extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, texture: string, frame?: string | number) {
        ...
        this.moveEvent = scene.time.addEvent({
            ...
            callback: () => {
                ...
                let chanceForIdle = Phaser.Math.Between(0, 2);
       ...
       // this.CurrentTrashTalk.setPosition(this.x+25,this.y-25)  
        switch (this.facing) {
            case Direction.UP:
                ...
                this.anims.play('enemy-bigchort-run', true)
                break
            case Direction.DOWN:
                this.setVelocity(0, this.ChortSpeed)
                this.anims.play('enemy-bigchort-run', true)
            ...
            case Direction.IDLE:
                this.setVelocity(this.ChortSpeed, this.ChortSpeed)
                this.anims.play('enemy-bigchort-idle', true)
                break
        }
    }
}